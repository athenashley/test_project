...
<head>
  ...
  <style>
    :root {
       --bs-primary: #7b5c38;
      --bs-primary-rgb: 123, 92, 56;
      --bs-secondary: #c8b6a6;
      --bs-light-brown: #f9f5f0;
      --bs-dark-brown: #5a4a3a;
    }
    .hero {
      height: 80vh;
      min-height: 600px;
    ...
    @keyframes slideshow {
      0% { background-image: url('pics/2.jpg'); }
      25% { background-image: url('pics/1.jpg'); }
      50% { background-image: url('pics/3.jpg'); }
      75% { background-image: url('pics/5.webp'); }
      100% { background-image: url('pics/7.webp'); }
    }
    .hero::before {
      content: "";
      position: absolute;
...
<script>
  ...
  function loadBookedDates() {
    $.ajax({
      url: "get-booked-dates.php",//icacall
      method: "GET",
      dataType: "json",
      success: function (dates) {
        bookedDates = dates;

        $("#checkin, #checkout").datepicker("destroy").datepicker({
          dateFormat: "yy-mm-dd",
          minDate: 0,
...
// dito nmn ung ilan ung guest na pede para sa mga room
  $(document).ready(function () {
    ...
    function updateGuestLimit() {
      ...
      if (guestsInput.value < limits.min || guestsInput.value > limits.max) {
    ...
    function loadRoomAvailability() {
      $.ajax({
        url: "get-room-availability.php",//icacall 
        method: "GET",
        dataType: "json",
