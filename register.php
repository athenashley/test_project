...
<body>
  ...
  <?php
    // para sa initialization ng variables for error messages and form values
    $usernameErr = $emailErr = $passwordErr = $cpasswordErr = "";
    $username = $email = $password = $cpassword = "";

    // username validation: walang space, tamang length (5-24)
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // email validation: required at dapat tamang format 
        ...
        // password validation: length 8–20, dapat may uppercase, lowercase, number at special character
        ...
        // confirm password validation: dapat nagmamatch sa password na una mong nilagay
        ...
        // eto yung kung walang error, magproceed sya sa pag-insert ng data sa database
